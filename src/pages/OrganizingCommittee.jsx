      ...
      >
        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/2 px-4">
            {/* Left Column Content */}
            <div className="mb-6">
              <h2 className="text-[#168BEE] text-xl font-bold mb-3">Patron</h2>
              <p>Venkappayya R Desai, Director, IIT DHARWAD</p>
            </div>

            <div className="mb-6">
              <h2 className="text-[#168BEE] text-xl font-bold mb-3">Honorary Chair</h2>
            ...
            <div className="mb-6">
              <h2 className="text-[#168BEE] text-xl font-bold mb-3">Technical Program Chairs</h2>
            ...
            <div className="mb-6">
              <h2 className="text-[#168BEE] text-xl font-bold mb-3">Special Session Chairs</h2>
            ...
            <div className="mb-6">
              <h2 className="text-[#168BEE] text-xl font-bold mb-3">Publication Chairs</h2>
            ...
            <div className="mb-6">
              <h2 className="text-[#168BEE] text-xl font-bold mb-3">Publicity Chairs</h2>
            ...
            <div className="mb-6">
              <h2 className="text-[#168BEE] text-xl font-bold mb-3">Finance Chair</h2>
          ...
          <div className="w-full md:w-1/2 px-4">
            <div className="mb-6">
              <h2 className="text-[#168BEE] text-xl font-bold mb-3">International Advisory Board</h2>
            ...
            <div className="mb-6">
              <h2 className="text-[#168BEE] text-xl font-bold mb-3">Student and Young Professionals Chairs</h2>
